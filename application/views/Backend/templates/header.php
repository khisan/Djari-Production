...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('Backend/templates/layout-2');
  $this->load->view('Backend/templates/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('Backend/templates/layout-3');
